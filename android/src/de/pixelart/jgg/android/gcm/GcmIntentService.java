    ...
    private void sendMessageNotification(String msg) {
		...
		mNotificationManager = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
 		NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(
					...
					.setSound(uri)
					.setAutoCancel(true)
					.setStyle(new NotificationCompat.BigTextStyle().bigText(Html.fromHtml(username+" neue Nachricht für dich:<br>"+msg) ))
					.setContentText(Html.fromHtml(username+" neue Nachricht für dich:<br>"+msg) )
