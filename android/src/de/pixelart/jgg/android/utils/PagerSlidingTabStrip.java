...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.row_tab, this, false);
            }
    ...
    private void scrollToChild(int position, int offset) {
        ...
        if (position > 0 || offset > 0) {
            ...
            //Half screen offset.
            //- Either tabs StartFragment at the middle of the view scrolling straight away
            //- Or tabs StartFragment at the begging (no padding) scrolling when indicator gets
    ...
    private Pair<Float, Float> getIndicatorCoordinates() {
        ...
        // if there is an offset, StartFragment interpolating left and right coordinates between current and next tab
